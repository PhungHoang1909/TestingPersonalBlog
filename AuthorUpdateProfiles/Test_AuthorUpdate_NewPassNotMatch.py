...
class Author_Update(unittest.TestCase):
    ...
    def test_NewPassNotMatch(self):
        ...
        con_password.send_keys("NewPassword456@")

        self.driver.find_element(By.NAME, "submit").click()

        message_element = self.driver.find_element(By.XPATH, "//div[@class='message']/span")
        self.assertEqual(message_element.text, "Confirm Password is not matched with new password!",
