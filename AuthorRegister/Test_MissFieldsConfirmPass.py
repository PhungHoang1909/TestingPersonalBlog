...
class Test_MissFieldsConfirmPass(unittest.TestCase):
    def setUp(self):
    ...
    def test_MissFieldsConfirmPass(self):

        username = self.driver.find_element(By.NAME, "name")
        username.send_keys("Alice1234!")
        ...
        cpassword = self.driver.find_element(By.NAME, "name")
        is_required = cpassword.get_attribute("required")
